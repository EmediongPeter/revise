...
export const BRAND_COLOR_HOVER = '#27272a';
...
// Clerk appearance overrides - Revise monochrome style
...
export const CLERK_AUTH_APPEARANCE_OVERRIDE = {
    ...
    socialButtonsBlockButton:
        '!border border-[rgba(9,9,11,0.1)] hover:bg-[#f4f4f5] transition-all h-12 text-lg !rounded-xl shadow-[0_1px_2px_rgba(15,23,42,0.05),0_8px_24px_rgba(15,23,42,0.06)]',
    socialButtonsBlockButtonText: 'font-medium !text-[#111827] !text-lg',
    formButtonPrimary:
        'bg-[#09090b] hover:bg-[#27272a] text-white font-medium !border-0 shadow-[0_1px_2px_rgba(15,23,42,0.05),0_8px_24px_rgba(15,23,42,0.06)] normal-case !h-12 !text-lg !rounded-xl',
    formFieldInput:
        '!border !border-[rgba(9,9,11,0.1)] !rounded-xl focus:ring-[#09090b] focus:border-[#09090b] !h-12 !min-h-12 !text-lg !bg-white shadow-[0_1px_2px_rgba(15,23,42,0.05)]',
    formFieldLabel: 'text-[#111827] font-medium text-lg',
    footerActionLink: 'text-[#09090b] hover:text-[#27272a] text-base font-medium',
};
